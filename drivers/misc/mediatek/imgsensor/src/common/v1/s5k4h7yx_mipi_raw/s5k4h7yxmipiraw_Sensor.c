...
#define DEVICE_VERSION_S5K4H7YX    "s5k4h7yx"
...
extern unsigned char s5k4h7yx_get_module_id(void);
#endif
//extern unsigned main_sub_flag;
static imgsensor_info_struct imgsensor_info = {
	.sensor_id = S5K4H7YX_SENSOR_ID,  //S5K4H7YX_SENSOR_ID = 0x487B
...
static void sensor_reg_dump(void)
{
	...
	LOG_ERR("+");
	LOG_ERR("Camera_S5K4H7YXOFILM_sensor RegDump start");
...
#if OTP_4H7
#define S5K4H7YX_EEPROM_SLAVE_ADD 0xB0
#define S5K4H7YX_SENSOR_IIC_SLAVE_ADD 0x20
#define S5K4H7YX_OFILM_MODULE_ID  0x07
...
static int  s5k4h7yx_read_data_from_eeprom(kal_uint8 slave, kal_uint32 start_add,kal_uint8 size)
{
	int i = 0;
	...
	s5k4h7yx_otp_data.module_id = module_id[0];
	LOG_ERR("s5k4h7yx_otp_data.module_id= 0x%x",s5k4h7yx_otp_data.module_id);

	spin_lock(&imgsensor_drv_lock);
	imgsensor.i2c_write_id = S5K4H7YX_SENSOR_IIC_SLAVE_ADD;
	spin_unlock(&imgsensor_drv_lock);

	return s5k4h7yx_otp_data.module_id;
}
#endif
/*************************************************************************
* FUNCTION
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			*sensor_id = ((read_cmos_sensor_8(0x0000) << 8) | read_cmos_sensor_8(0x0001));
			...
			// imgsensor_info.module_id = s5k4h7yx_get_module_id();
...
#if OTP_4H7
				s5k4h7yx_read_data_from_eeprom(S5K4H7YX_EEPROM_SLAVE_ADD,0x000B,1);
#if INCLUDE_NO_OTP_4H7
				if ((s5k4h7yx_otp_data.module_id > 0) && (s5k4h7yx_otp_data.module_id < 0xFFFF)) {
#endif
					if (s5k4h7yx_otp_data.module_id != S5K4H7YX_OFILM_MODULE_ID) {
						*sensor_id = 0xFFFFFFFF;
						return ERROR_SENSOR_CONNECT_FAIL;
					} else {
						LOG_INF("This is ofilm --->s5k4h7yx otp data vaild ...");
						hq_regiser_hw_info(HWID_MAIN_CAM, "ofilm s5k4h7yx 8m");
					}
#if INCLUDE_NO_OTP_4H7
				} else {
