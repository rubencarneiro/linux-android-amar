...
void usb_phy_recover(struct musb *musb)
{
	...
	usb_phy_tuning();
        value = USBPHY_READ32(0x04);
	printk("=======leon-usb======0x04[%08x]============",value);
	//value &= ~0x0000ff00;
	//value |= 0x00007700;
	//USBPHY_SET32(0x04, value);
	//printk("=======leon-usb======0x04[%08x]============",USBPHY_READ32(0x04));



	value = USBPHY_READ32(0x14);
	printk("=======leon-usb======0x14[%08x]============",value);
	//value &= ~0x00007000;
	//value |= 0x00007000;
	//USBPHY_SET32(0x14, value);
	//printk("=======leon-usb======0x14[%08x]============",USBPHY_READ32(0x14));
