...
//Interrupt and config
	...
	//--------AFE Control
	{
		...
		.val = 0x40,       // CSx pin during sleep mode : HZ
	},
	{
	...
	},
	{
		...
		.val = 0x87,       //Sampling Freq(ph0/1) : 83.33khz(01000), Resolution(ph0/1) : 128(100)
	},
	{
	...
	},
	{
		...
		.val = 0x87,       //Sampling Freq(ph2/3) : 83.33khz(01000), Resolution(ph2/3) : 128(100)
	},
	{
	...
	},
	{
		...
		.val = 0x0F,       // Analg gain : x1(1000)
	},
	//--------PROX control
	{
		.reg = SX932x_PROX_CTRL0_REG,  //0x30
		.val = 0x0b,       // Digital Gain(ph0/1) : off(001) Digital Filter(ph0/1) : 1-1/2(001)
	},
	{
		.reg = SX932x_PROX_CTRL1_REG,  //0x31
		.val = 0x13,       // Digital Gain(ph2/3) : off(001) Digital Filter(ph2/3) : 1-1/2(001)
	},
	{
	...
	},
	{
		...
		.val = 0x0d,       // Prox Theshold(ph0/1) : 200
	},
	{
		.reg = SX932x_PROX_CTRL7_REG,  //0x37
		.val = 0x0e,       // Prox Theshold(ph2/3) : 200
	},
	...
	//--------Sensor enable
	{
		...
		.val = 0x27,       //enable PH0~2
	},
};

static struct _buttonInfo psmtcButtons[] = {
	{
		.keycode = KEY_CAPSENSOR_F4,
		.mask = SX932x_PROXSTAT_PH0_FLAG,
	},
	{
		.keycode = KEY_CAPSENSOR_F3,
		.mask = SX932x_PROXSTAT_PH1_FLAG,
	},
	{
		.keycode = KEY_CAPSENSOR_F2,
		.mask = SX932x_PROXSTAT_PH2_FLAG,
	},
	{
		.keycode = KEY_CAPSENSOR_F1,
