...
struct charger_ops {
	...
	int (*is_otg)(void);
	int (*is_pogo_enable)(void);
	int (*enable_discharge)(struct charger_device *dev, bool en);
	int (*factory_discharge)(struct charger_device *dev, bool en);
	int (*pogo_enable)(struct charger_device *dev, bool en);
...
extern int charger_dev_enable_otg(
	struct charger_device *charger_dev, bool en);
extern int charger_dev_is_otg(
	struct charger_device *chg_dev);
extern int charger_dev_is_pogo_enable(
	struct charger_device *chg_dev);
extern int charger_dev_enable_discharge(
	struct charger_device *charger_dev, bool en);
extern int charger_dev_factory_discharge(
	struct charger_device *charger_dev, bool en);
extern int charger_dev_pogo_enable(
	struct charger_device *charger_dev, bool en);
