...
#define AC107_LRCK_PERIOD		(AC107_SLOT_WIDTH*(AC107_ENCODING_EN ? 2 : AC107_CHIP_NUMS*2))	//range[1, 1024], default PCM mode, I2S/LJ/RJ mode shall divide by 2
#define AC107_MATCH_DTS_EN		0					//AC107 match method select: 0: i2c_detect, 1:devices tree

#define AC107_KCONTROL_EN		0
...
struct i2c_client *i2c_ctrl[AC107_CHIP_NUMS];
...
const u8 ac107_kcontrol_dapm_reg[] = {
	...
	ANA_ADC1_CTRL3, ANA_ADC2_CTRL3, ADC1_DVOL_CTRL, ADC2_DVOL_CTRL, ADC1_DMIX_SRC, ADC2_DMIX_SRC, ADC_DIG_DEBUG,
#endif

#if AC107_DAPM_EN
	DMIC_EN, ADC1_DMIX_SRC, ADC2_DMIX_SRC, I2S_TX_CHMP_CTRL1, I2S_TX_CHMP_CTRL2, ANA_ADC1_CTRL5, ANA_ADC2_CTRL5, ADC_DIG_EN,
#endif
};


static int ac107_read(u8 reg, u8 *rt_value, struct i2c_client *client);
static int ac107_update_bits(u8 reg, u8 mask, u8 value, struct i2c_client *client);
...
static const struct snd_kcontrol_new ac107_volume_controls[] = {
	//Channels PGA Gain
	SOC_SINGLE_EXT_TLV("Channel 1 PGA Gain",  ANA_ADC1_CTRL3, RX1_PGA_GAIN_CTRL, 0x1f, 0, ac107_codec0_get, ac107_codec0_put, adc_pga_gain_tlv),
	SOC_SINGLE_EXT_TLV("Channel 2 PGA Gain",  ANA_ADC2_CTRL3, RX2_PGA_GAIN_CTRL, 0x1f, 0, ac107_codec0_get, ac107_codec0_put, adc_pga_gain_tlv),
	#if 0
	SOC_SINGLE_EXT_TLV("Channel 3 PGA Gain",  ANA_ADC1_CTRL3, RX1_PGA_GAIN_CTRL, 0x1f, 0, ac107_codec1_get, ac107_codec1_put, adc_pga_gain_tlv),
	SOC_SINGLE_EXT_TLV("Channel 4 PGA Gain",  ANA_ADC2_CTRL3, RX2_PGA_GAIN_CTRL, 0x1f, 0, ac107_codec1_get, ac107_codec1_put, adc_pga_gain_tlv),
	SOC_SINGLE_EXT_TLV("Channel 5 PGA Gain",  ANA_ADC1_CTRL3, RX1_PGA_GAIN_CTRL, 0x1f, 0, ac107_codec2_get, ac107_codec2_put, adc_pga_gain_tlv),
	SOC_SINGLE_EXT_TLV("Channel 6 PGA Gain",  ANA_ADC2_CTRL3, RX2_PGA_GAIN_CTRL, 0x1f, 0, ac107_codec2_get, ac107_codec2_put, adc_pga_gain_tlv),
	SOC_SINGLE_EXT_TLV("Channel 7 PGA Gain",  ANA_ADC1_CTRL3, RX1_PGA_GAIN_CTRL, 0x1f, 0, ac107_codec3_get, ac107_codec3_put, adc_pga_gain_tlv),
	SOC_SINGLE_EXT_TLV("Channel 8 PGA Gain",  ANA_ADC2_CTRL3, RX2_PGA_GAIN_CTRL, 0x1f, 0, ac107_codec3_get, ac107_codec3_put, adc_pga_gain_tlv),
	SOC_SINGLE_EXT_TLV("Channel 9 PGA Gain",  ANA_ADC1_CTRL3, RX1_PGA_GAIN_CTRL, 0x1f, 0, ac107_codec4_get, ac107_codec4_put, adc_pga_gain_tlv),
	SOC_SINGLE_EXT_TLV("Channel 10 PGA Gain", ANA_ADC2_CTRL3, RX2_PGA_GAIN_CTRL, 0x1f, 0, ac107_codec4_get, ac107_codec4_put, adc_pga_gain_tlv),
	SOC_SINGLE_EXT_TLV("Channel 11 PGA Gain", ANA_ADC1_CTRL3, RX1_PGA_GAIN_CTRL, 0x1f, 0, ac107_codec5_get, ac107_codec5_put, adc_pga_gain_tlv),
	SOC_SINGLE_EXT_TLV("Channel 12 PGA Gain", ANA_ADC2_CTRL3, RX2_PGA_GAIN_CTRL, 0x1f, 0, ac107_codec5_get, ac107_codec5_put, adc_pga_gain_tlv),
	SOC_SINGLE_EXT_TLV("Channel 13 PGA Gain", ANA_ADC1_CTRL3, RX1_PGA_GAIN_CTRL, 0x1f, 0, ac107_codec6_get, ac107_codec6_put, adc_pga_gain_tlv),
	SOC_SINGLE_EXT_TLV("Channel 14 PGA Gain", ANA_ADC2_CTRL3, RX2_PGA_GAIN_CTRL, 0x1f, 0, ac107_codec6_get, ac107_codec6_put, adc_pga_gain_tlv),
	SOC_SINGLE_EXT_TLV("Channel 15 PGA Gain", ANA_ADC1_CTRL3, RX1_PGA_GAIN_CTRL, 0x1f, 0, ac107_codec7_get, ac107_codec7_put, adc_pga_gain_tlv),
	SOC_SINGLE_EXT_TLV("Channel 16 PGA Gain", ANA_ADC2_CTRL3, RX2_PGA_GAIN_CTRL, 0x1f, 0, ac107_codec7_get, ac107_codec7_put, adc_pga_gain_tlv),
	#endif
	
	//Channels Digital Volume
	SOC_SINGLE_EXT_TLV("Channel 1 Digital Volume",  ADC1_DVOL_CTRL, 0, 0xff, 0, ac107_codec0_get, ac107_codec0_put, digital_vol_tlv),
	SOC_SINGLE_EXT_TLV("Channel 2 Digital Volume",  ADC2_DVOL_CTRL, 0, 0xff, 0, ac107_codec0_get, ac107_codec0_put, digital_vol_tlv),
	#if 0
	SOC_SINGLE_EXT_TLV("Channel 3 Digital Volume",  ADC1_DVOL_CTRL, 0, 0xff, 0, ac107_codec1_get, ac107_codec1_put, digital_vol_tlv),
	SOC_SINGLE_EXT_TLV("Channel 4 Digital Volume",  ADC2_DVOL_CTRL, 0, 0xff, 0, ac107_codec1_get, ac107_codec1_put, digital_vol_tlv),
	SOC_SINGLE_EXT_TLV("Channel 5 Digital Volume",  ADC1_DVOL_CTRL, 0, 0xff, 0, ac107_codec2_get, ac107_codec2_put, digital_vol_tlv),
	SOC_SINGLE_EXT_TLV("Channel 6 Digital Volume",  ADC2_DVOL_CTRL, 0, 0xff, 0, ac107_codec2_get, ac107_codec2_put, digital_vol_tlv),
	SOC_SINGLE_EXT_TLV("Channel 7 Digital Volume",  ADC1_DVOL_CTRL, 0, 0xff, 0, ac107_codec3_get, ac107_codec3_put, digital_vol_tlv),
	SOC_SINGLE_EXT_TLV("Channel 8 Digital Volume",  ADC2_DVOL_CTRL, 0, 0xff, 0, ac107_codec3_get, ac107_codec3_put, digital_vol_tlv),
	SOC_SINGLE_EXT_TLV("Channel 9 Digital Volume",  ADC1_DVOL_CTRL, 0, 0xff, 0, ac107_codec4_get, ac107_codec4_put, digital_vol_tlv),
	SOC_SINGLE_EXT_TLV("Channel 10 Digital Volume", ADC2_DVOL_CTRL, 0, 0xff, 0, ac107_codec4_get, ac107_codec4_put, digital_vol_tlv),
	SOC_SINGLE_EXT_TLV("Channel 11 Digital Volume", ADC1_DVOL_CTRL, 0, 0xff, 0, ac107_codec5_get, ac107_codec5_put, digital_vol_tlv),
	SOC_SINGLE_EXT_TLV("Channel 12 Digital Volume", ADC2_DVOL_CTRL, 0, 0xff, 0, ac107_codec5_get, ac107_codec5_put, digital_vol_tlv),
	SOC_SINGLE_EXT_TLV("Channel 13 Digital Volume", ADC1_DVOL_CTRL, 0, 0xff, 0, ac107_codec6_get, ac107_codec6_put, digital_vol_tlv),
	SOC_SINGLE_EXT_TLV("Channel 14 Digital Volume", ADC2_DVOL_CTRL, 0, 0xff, 0, ac107_codec6_get, ac107_codec6_put, digital_vol_tlv),
	SOC_SINGLE_EXT_TLV("Channel 15 Digital Volume", ADC1_DVOL_CTRL, 0, 0xff, 0, ac107_codec7_get, ac107_codec7_put, digital_vol_tlv),
	SOC_SINGLE_EXT_TLV("Channel 16 Digital Volume", ADC2_DVOL_CTRL, 0, 0xff, 0, ac107_codec7_get, ac107_codec7_put, digital_vol_tlv),
	#endif
};
...
static const struct snd_kcontrol_new ac107_controls[] = {
	...
	SOC_SINGLE_TLV("ADC1 PGA Gain", ANA_ADC1_CTRL3, RX1_PGA_GAIN_CTRL, 0x1f, 0, adc_pga_gain_tlv),
	SOC_SINGLE_TLV("ADC2 PGA Gain", ANA_ADC2_CTRL3, RX2_PGA_GAIN_CTRL, 0x1f, 0, adc_pga_gain_tlv),

	SOC_SINGLE_TLV("CH1 Digital Volume", ADC1_DVOL_CTRL, 0, 0xff, 0, digital_vol_tlv),
	SOC_SINGLE_TLV("CH2 Digital Volume", ADC2_DVOL_CTRL, 0, 0xff, 0, digital_vol_tlv),

	SOC_SINGLE_TLV("CH1 ch1 Mixer Volume", ADC1_DMIX_SRC, ADC1_ADC1_DMXL_GC, 1, 0, digital_mix_vol_tlv),
	SOC_SINGLE_TLV("CH1 ch2 Mixer Volume", ADC1_DMIX_SRC, ADC1_ADC2_DMXL_GC, 1, 0, digital_mix_vol_tlv),

	SOC_SINGLE_TLV("CH2 ch1 Mixer Volume", ADC2_DMIX_SRC, ADC2_ADC1_DMXL_GC, 1, 0, digital_mix_vol_tlv),
	SOC_SINGLE_TLV("CH2 ch2 Mixer Volume", ADC2_DMIX_SRC, ADC2_ADC2_DMXL_GC, 1, 0, digital_mix_vol_tlv),
#endif
	//debug control
...
static const struct snd_soc_dapm_widget ac107_dapm_widgets[] = {
	...
	//ADC DMIC MUX
	SND_SOC_DAPM_MUX("ADC DMIC MUX", ADC_DIG_EN, DG_EN, 0, &adc_dmic_src_mux),
	...
	//I2S TX CH1 MUX
	SND_SOC_DAPM_MUX("I2S TX CH1 MUX", SND_SOC_NOPM, 0, 0, &i2s_tx_ch1_map_mux),

	//I2S TX CH2 MUX
	SND_SOC_DAPM_MUX("I2S TX CH2 MUX", SND_SOC_NOPM, 0, 0, &i2s_tx_ch2_map_mux),

	//I2S TX CH3 MUX
	SND_SOC_DAPM_MUX("I2S TX CH3 MUX", SND_SOC_NOPM, 0, 0, &i2s_tx_ch3_map_mux),

	//I2S TX CH4 MUX
	SND_SOC_DAPM_MUX("I2S TX CH4 MUX", SND_SOC_NOPM, 0, 0, &i2s_tx_ch4_map_mux),

	//I2S TX CH5 MUX
	SND_SOC_DAPM_MUX("I2S TX CH5 MUX", SND_SOC_NOPM, 0, 0, &i2s_tx_ch5_map_mux),

	//I2S TX CH6 MUX
	SND_SOC_DAPM_MUX("I2S TX CH6 MUX", SND_SOC_NOPM, 0, 0, &i2s_tx_ch6_map_mux),

	//I2S TX CH7 MUX
	SND_SOC_DAPM_MUX("I2S TX CH7 MUX", SND_SOC_NOPM, 0, 0, &i2s_tx_ch7_map_mux),

	//I2S TX CH8 MUX
	SND_SOC_DAPM_MUX("I2S TX CH8 MUX", SND_SOC_NOPM, 0, 0, &i2s_tx_ch8_map_mux),

	//I2S TX CH9 MUX
	SND_SOC_DAPM_MUX("I2S TX CH9 MUX", SND_SOC_NOPM, 0, 0, &i2s_tx_ch9_map_mux),

	//I2S TX CH10 MUX
	SND_SOC_DAPM_MUX("I2S TX CH10 MUX", SND_SOC_NOPM, 0, 0, &i2s_tx_ch10_map_mux),

	//I2S TX CH11 MUX
	SND_SOC_DAPM_MUX("I2S TX CH11 MUX", SND_SOC_NOPM, 0, 0, &i2s_tx_ch11_map_mux),

	//I2S TX CH12 MUX
	SND_SOC_DAPM_MUX("I2S TX CH12 MUX", SND_SOC_NOPM, 0, 0, &i2s_tx_ch12_map_mux),

	//I2S TX CH13 MUX
	SND_SOC_DAPM_MUX("I2S TX CH13 MUX", SND_SOC_NOPM, 0, 0, &i2s_tx_ch13_map_mux),

	//I2S TX CH14 MUX
	SND_SOC_DAPM_MUX("I2S TX CH14 MUX", SND_SOC_NOPM, 0, 0, &i2s_tx_ch14_map_mux),

	//I2S TX CH15 MUX
	SND_SOC_DAPM_MUX("I2S TX CH15 MUX", SND_SOC_NOPM, 0, 0, &i2s_tx_ch15_map_mux),

	//I2S TX CH16 MUX
	SND_SOC_DAPM_MUX("I2S TX CH16 MUX", SND_SOC_NOPM, 0, 0, &i2s_tx_ch16_map_mux),
...
void ac107_dump_regs(struct i2c_client *i2c)
{
	int i=0;
	u8 reg_val;
	for(i=0x0;i<=0xaa;i++)
	{
		ac107_read(i, &reg_val, i2c);
		pr_err("ac107_read [REG-0x%02x] =0x%d\n",i,reg_val);
	}
	
}

void loader_set_value(struct i2c_client *i2c)
{
	u8 i;
	const struct reg_default_value ac107_reg_address_value[] = {
		{0x00,0x12},
		{0x01,0x80},
		{0x02,0x55},
		{0x10,0x4f},
	...
	for(i=0; i<ARRAY_SIZE(ac107_reg_address_value); i++){
		ac107_write(ac107_reg_address_value[i].reg_addr, ac107_reg_address_value[i].default_val, i2c);
	}
}

void ac107_start(void)
{
	ac107_hw_init( i2c_ctrl[0]);	/*0x01=0x80: VREF Enable*/
	pr_err("[AC107] %s\n", __func__);
}

void ac107_stop(void)
{
	ac107_write(CHIP_AUDIO_RST, 0x12, i2c_ctrl[0]);	/*0x01=0x80: VREF Enable*/
	pr_err("[AC107] %s\n", __func__);
}
...
static void ac107_hw_init(struct i2c_client *i2c)
{
	...
	ac107_update_bits(I2S_FMT_CTRL1, 0x1<<ENCD_FMT | 0x1<<ENCD_SEL | 0x1<<TX_SLOT_HIZ | 0x1<<TX_STATE,\
					!!AC107_ENCODING_FMT<<ENCD_FMT | !!AC107_ENCODING_EN<<ENCD_SEL | 0x0<<TX_SLOT_HIZ | 0x1<<TX_STATE, i2c);
	...
	ac107_update_bits(I2S_FMT_CTRL3, 0x1<<TX_MLS | 0x1<<SDOUT_MUTE | 0x1<<LRCK_WIDTH | 0x3<<TX_PDM,\
									 0x0<<TX_MLS | 0x0<<SDOUT_MUTE | 0x0<<LRCK_WIDTH | 0x0<<TX_PDM, i2c);
	...
	loader_set_value(i2c);
	
}


static int ac107_set_sysclk(struct snd_soc_dai *dai, int clk_id, unsigned int freq, int dir)
{
	AC107_DEBUG("\n--->%s\n",__FUNCTION__);
	...
	//SYSCLK Enable
	ac107_multi_chips_update_bits(SYSCLK_CTRL, 0x1<<SYSCLK_EN, 0x1<<SYSCLK_EN);
	return 0;
}

static int ac107_set_pll(struct snd_soc_dai *dai, int pll_id, int source, unsigned int freq_in, unsigned int freq_out)
{
	u32 i,m1,m2,n,k1,k2;
	AC107_DEBUG("\n--->%s\n",__FUNCTION__);
	...
	if (freq_in < 128000 || freq_in > 24576000) {
		pr_err("AC107 PLLCLK source input freq only support [128K,24M],while now %u\n\n",freq_in);
		return -EINVAL;
		...
		AC107_DEBUG("AC107 don't need to use PLL, SYSCLK source select %s\n\n",pll_id ? "BCLK" : "MCLK");
	...
	switch(pll_id){
		case PLLCLK_SRC_MCLK:
			...
			ac107_multi_chips_update_bits(SYSCLK_CTRL, 0x3<<PLLCLK_SRC, PLLCLK_SRC_MCLK<<PLLCLK_SRC);
			break;
		case PLLCLK_SRC_BCLK:
			AC107_DEBUG("AC107 PLLCLK input source select BCLK\n");
			ac107_multi_chips_update_bits(SYSCLK_CTRL, 0x3<<PLLCLK_SRC, PLLCLK_SRC_BCLK<<PLLCLK_SRC);
			break;
		case PLLCLK_SRC_PDMCLK:
			AC107_DEBUG("AC107 PLLCLK input source select PDMCLK\n");
			ac107_multi_chips_update_bits(SYSCLK_CTRL, 0x3<<PLLCLK_SRC, PLLCLK_SRC_PDMCLK<<PLLCLK_SRC);
			break;
		default:
	...
	if(i == ARRAY_SIZE(ac107_pll_div)){
		pr_err("AC107 don't match PLLCLK freq_in and freq_out table\n\n");
		return -EINVAL;
	}
	...
	ac107_multi_chips_update_bits(PLL_CTRL4, 0xff<<PLL_LOOPDIV_LSB, (u8)n<<PLL_LOOPDIV_LSB);
	...
	ac107_multi_chips_update_bits(SYSCLK_CTRL, 0x1<<PLLCLK_EN | 0x1<<SYSCLK_EN, 0x1<<PLLCLK_EN | 0x1<<SYSCLK_EN);
...
static int ac107_set_clkdiv(struct snd_soc_dai *dai, int div_id, int div)
{
	...
	if(!div_id){	//use div_id to judge Master/Slave mode,  0: Slave mode, 1: Master mode
		AC107_DEBUG("AC107 work as Slave mode, don't need to config BCLK_DIV\n\n");
		return 0;
	}
	...
	//AC107 set BCLK DIV
	ac107_multi_chips_update_bits(I2S_BCLK_CTRL, 0xf<<BCLKDIV, bclk_div_reg_val<<BCLKDIV);
	return 0;
}
...
static int ac107_set_fmt(struct snd_soc_dai *dai, unsigned int fmt)
{
	...
	for(i=0; i<AC107_CHIP_NUMS; i++){	//multi_chips: only one chip set as Master, and the others also need to set as Slave
		if(i2c_ctrl[i] == ac107->i2c) continue;
	...
	switch (fmt & SND_SOC_DAIFMT_INV_MASK) {
		case SND_SOC_DAIFMT_NB_NF:
			AC107_DEBUG("AC107 config BCLK&LRCK polarity: BCLK_normal,LRCK_normal\n");
			brck_polarity = BCLK_NORMAL_DRIVE_N_SAMPLE_P;
			lrck_polarity = LRCK_LEFT_LOW_RIGHT_HIGH;
			break;
		case SND_SOC_DAIFMT_NB_IF:
			AC107_DEBUG("AC107 config BCLK&LRCK polarity: BCLK_normal,LRCK_invert\n");
			brck_polarity = BCLK_NORMAL_DRIVE_N_SAMPLE_P;
			lrck_polarity = LRCK_LEFT_HIGH_RIGHT_LOW;
			break;
		case SND_SOC_DAIFMT_IB_NF:
			AC107_DEBUG("AC107 config BCLK&LRCK polarity: BCLK_invert,LRCK_normal\n");
			brck_polarity = BCLK_INVERT_DRIVE_P_SAMPLE_N;
			lrck_polarity = LRCK_LEFT_LOW_RIGHT_HIGH;
			break;
		case SND_SOC_DAIFMT_IB_IF:
			AC107_DEBUG("AC107 config BCLK&LRCK polarity: BCLK_invert,LRCK_invert\n");
			brck_polarity = BCLK_INVERT_DRIVE_P_SAMPLE_N;
			lrck_polarity = LRCK_LEFT_HIGH_RIGHT_LOW;
			break;
		default:
...
static int ac107_hw_params(struct snd_pcm_substream *substream, struct snd_pcm_hw_params *params, struct snd_soc_dai *dai)
{
	...
	for(i=0; i<ARRAY_SIZE(ac107_sample_rate); i++){
		if(ac107_sample_rate[i].real_val == params_rate(params) / (AC107_ENCODING_EN ? AC107_ENCODING_CH_NUMS/2 : 1)){
	...
	//AC107 set channels
	channels = params_channels(params) * (AC107_ENCODING_EN ? AC107_ENCODING_CH_NUMS/2 : 1);
	...
	case SNDRV_PCM_FORMAT_S32_LE:
		...
		break;
	default:
		dev_err(dai->dev, "AC107 don't supported the sample resolution: %u\n", params_format(params));
		return -EINVAL;
	}
...
//	u8 i,j;
	...
	for(i=0; i<ARRAY_SIZE(ac107_reg_default_value); i++){
		...
		if(j == sizeof(ac107_kcontrol_dapm_reg)){
			ac107_multi_chips_write(ac107_reg_default_value[i].reg_addr, ac107_reg_default_value[i].default_val);
		}
	}
...
static int ac107_probe(struct snd_soc_component *component)
{
	...
	//component->control_data = devm_regmap_init_i2c(ac107->i2c, &ac107_regmap_config);
	ret = PTR_RET(devm_regmap_init_i2c(ac107->i2c, &ac107_regmap_config));
	if(ret){
...
static int ac107_suspend(struct snd_soc_component *component)
{
	...
	if ((ac107_regulator_en&0x2) && !IS_ERR(ac107->vol_supply.avcc_vccio_3v3)) {
		regulator_disable(ac107->vol_supply.avcc_vccio_3v3);
		ac107_regulator_en &= ~0x2;
	}
#endif
	ac107_write(CHIP_AUDIO_RST, 0x12, ac107->i2c);	/*0x01=0x80: VREF Enable*/
	pr_err("[AC107] %s: CHIP_AUDIO_RST\n", __func__);
...
static int ac107_resume(struct snd_soc_component *component)
{
	...
	if (!(ac107_regulator_en&0x1) && !IS_ERR(ac107->vol_supply.dvcc_1v8)) {
		...
		if(ret != 0)
			pr_err("[AC107] %s: some error happen, fail to enable regulator dvcc_1v8!\n", __func__);
		ac107_regulator_en |= 0x1;
	}
	...
	if (!(ac107_regulator_en&0x2) && !IS_ERR(ac107->vol_supply.avcc_vccio_3v3)) {
		...
		if(ret != 0)
			pr_err("[AC107] %s: some error happen, fail to enable regulator avcc_vccio_3v3!\n", __func__);
		ac107_regulator_en |= 0x2;
	}
#endif
...
static unsigned int ac107_codec_read(struct snd_soc_component *component, unsigned int reg)
{
	//AC107_DEBUG("\n--->%s\n",__FUNCTION__);
	u8 val_r;
	struct ac107_priv *ac107 = dev_get_drvdata(component->dev);
...
static int ac107_codec_write(struct snd_soc_component *component, unsigned int reg, unsigned int value)
{
	//AC107_DEBUG("\n--->%s\n",__FUNCTION__);
...
/*** define  ac107  codec_driver struct ***/
 const struct snd_soc_component_driver ac107_soc_component_driver = {
	.probe = ac107_probe,
	.remove = ac107_remove,
...
//	const char *regulator_name = NULL;
	...
	if (!ac107_regulator_en) {
		...
		if (ret) {
			...
			if (IS_ERR(ac107->vol_supply.avcc_vccio_3v3) || !ac107->vol_supply.avcc_vccio_3v3) {
				pr_err("get ac107 avcc_vccio_3v3 failed, return!\n");
				return -EFAULT;
			}
			...
			/*ac107->vol_supply.avcc_vccio_3v3= regulator_get(NULL, "vcn33_wifi");
			if (IS_ERR(ac107->vol_supply.avcc_vccio_3v3) || !ac107->vol_supply.avcc_vccio_3v3) {
				pr_err("get ac107 avcc_vccio_3v3 failed, return!\n");
				return -EFAULT;
			}
	...
	if (i2c_id->driver_data < AC107_CHIP_NUMS) {
		...
		ret = snd_soc_register_component(&i2c->dev, &ac107_soc_component_driver, ac107_dai[i2c_id->driver_data], 1);//(struct snd_soc_dai_driver *)
		if (ret < 0) {
			dev_err(&i2c->dev, "Failed to register ac107 codec: %d\n", ret);
		}
	} else {
	...
	// add 
	pr_err("ac107_hw_init\n");
	i2c_ctrl[0]=i2c;
	ac107_hw_init(i2c_ctrl[0]);
	ac107_chip_id = 0;
	ret = ac107_read(CHIP_AUDIO_RST,&ac107_chip_id,i2c_ctrl[0]);
	if (ret < 0) {
		pr_err("probe ac107: failed to read chip id\n");
	}
//	ac107_dump_regs(i2c_ctrl[0]);
...
#if   0
static struct i2c_board_info ac107_i2c_board_info[] = {
#if AC107_CHIP_NUMS > 0
...
static int ac107_i2c_suspend(struct device *dev)
{
	ac107_write(CHIP_AUDIO_RST, 0x12, i2c_ctrl[0]);	/*0x01=0x80: VREF Enable*/
	pr_err("[AC107] %s\n", __func__);
	return 0;
...
static int ac107_i2c_resume(struct device *dev)
{
	pr_err("[AC107] %s\n", __func__);
	return 0;
}
    ...
    static const struct dev_pm_ops ac107_i2c_pm_ops = {
        SET_SYSTEM_SLEEP_PM_OPS(ac107_i2c_suspend, ac107_i2c_resume)
    };
    #endif
#endif
