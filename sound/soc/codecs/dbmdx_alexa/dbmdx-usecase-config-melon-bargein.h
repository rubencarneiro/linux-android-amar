...
static struct usecase_config config_uc_melon_barge_in_2mic = {
	...
	.usecase_supports_us_buffering = true,
			...
			!defined(DBMDX_MELON_SAMPLES_BUF_IN_GA_MODE)
...
#ifdef DBMDX_MELON_BARGEIN_GA_MODE
	.complex_clb_1 = uc_lp_model_config_dummy,
	.complex_clb_2 = uc_lp_model_config_dummy,
#else
...
#ifdef DBMDX_MELON_BARGEIN_GA_MODE
#ifdef DBMDX_MELON_SAMPLES_BUF_IN_GA_MODE
