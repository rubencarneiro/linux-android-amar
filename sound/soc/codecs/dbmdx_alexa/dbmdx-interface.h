...
#include <dt-bindings/sound/dbmdx-va-regmap_alexa.h>
...
#if defined(CONFIG_SND_SOC_DBMDX_MELON_SAMPLES_BUF_IN_GA_MODE)
#if !defined(DBMDX_MELON_SAMPLES_BUF_IN_GA_MODE)
#define DBMDX_MELON_SAMPLES_BUF_IN_GA_MODE	1
#endif
#endif


#if defined(CONFIG_SND_SOC_DBMDX_VT_LOCAL_WHILE_VC_SUPPORTED)
#if !defined(VT_LOCAL_WHILE_VC_SUPPORTED)
#define VT_LOCAL_WHILE_VC_SUPPORTED		1
#endif
#endif

#if defined(CONFIG_SND_SOC_DBMDX_VT_CLOUD_WHILE_VC_SUPPORTED)
#if !defined(VT_CLOUD_WHILE_VC_SUPPORTED)
#define VT_CLOUD_WHILE_VC_SUPPORTED		1
#endif
#endif
...
#if defined(CONFIG_SND_SOC_DBMDX_VA_VE_I2S_MASTER)
...
#if defined(CONFIG_SND_SOC_DBMDX_VA_I2S_MASTER)
#if !defined(VA_I2S_MASTER)
#define VA_I2S_MASTER		1
#endif
#endif
...
#if defined(CONFIG_SND_SOC_DBMDX_BIXBY_WWE_SUPPORT)
#if !defined(DMBDX_BIXBY_AMODEL_SUPPORT)
#define DMBDX_BIXBY_AMODEL_SUPPORT	1
#endif
#endif
...
#if defined(CONFIG_SND_SOC_DBMDX_MANGO_BARGEIN_USES_2_MICS)
#if !defined(DBMDX_MANGO_BARGEIN_USES_2_MICS)
#define DBMDX_MANGO_BARGEIN_USES_2_MICS		1
#endif
#endif

#if defined(CONFIG_SND_SOC_DBMDX_MANGO_SRATE_16KHZ)
#if !defined(DBMDX_MANGO_SRATE_16000)
#define DBMDX_MANGO_SRATE_16000	1
#endif
#endif
...
#if defined(CONFIG_SND_SOC_DBMDX_PSAD_SUPPORTED)
#if !defined(DBMDX_PSAD_SUPPORTED)
#define DBMDX_PSAD_SUPPORTED		1
#endif
#endif
...
#ifndef DBMDX_SENSORY_VT_GRAM_NAME
#define DBMDX_SENSORY_VT_GRAM_NAME		"voice_grammar_sensory.bin"
#endif
...
#ifndef DBMDX_SENSORY_VT_NET_NAME
#define DBMDX_SENSORY_VT_NET_NAME		"voice_net_sensory.bin"
#endif
...
#ifndef DBMDX_SENSORY_VT_AMODEL_NAME
#define DBMDX_SENSORY_VT_AMODEL_NAME		"voice_amodel_sensory.bin"
#endif

#ifndef DBMDX_ALEXA_VT_AMODEL_NAME
#define DBMDX_ALEXA_VT_AMODEL_NAME		"voice_amodel_alexa.bin"
#endif

#ifndef DBMDX_GOOGLE_VT_AMODEL_NAME
#define DBMDX_GOOGLE_VT_AMODEL_NAME		"voice_amodel_google.bin"
#endif

#ifndef DBMDX_BIXBY_VT_AMODEL_NAME
#define DBMDX_BIXBY_VT_AMODEL_NAME		"voice_amodel_bixby.bin"
#endif
...
#ifndef DBMDX_SENSORY_VC_GRAM_NAME
#define DBMDX_SENSORY_VC_GRAM_NAME		"vc_grammar_sensory.bin"
#endif
...
#ifndef DBMDX_SENSORY_VC_NET_NAME
#define DBMDX_SENSORY_VC_NET_NAME		"vc_net_sensory.bin"
#endif
...
#ifndef DBMDX_SENSORY_VC_AMODEL_NAME
#define DBMDX_SENSORY_VC_AMODEL_NAME		"vc_amodel_sensory.bin"
#endif
...
#define DBMDX_MSLEEP_CONFIG_HOST_CLOCK_32KHZ	40
...
#define DBMDX_AMODEL_SENSORY_DEFAULT_OPTIONS	0x0000
...
#define DBMDX_OKG_TRIGGER_LENGTH_IN_SAMPLES	0x7d0
...
enum dbmdx_vt_engine_type {
	...
	DBMDX_VT_ENGINE_TYPE_SENSORY,
	DBMDX_VT_ENGINE_TYPE_ALEXA,
	DBMDX_VT_ENGINE_TYPE_GOOGLE,
	DBMDX_VT_ENGINE_TYPE_BIXBY,
...
enum dbmdx_load_amodel_mode {
	...
	LOAD_AMODEL_ASRP = 4,
	LOAD_AMODEL_ASRP_2ND_INIT = 5,
	LOAD_AMODEL_MAX = LOAD_AMODEL_ASRP_2ND_INIT,
};
...
#endif /* USE_KERNEL_ABOVE_4_17_XX */
...
int dbmdx_set_pcm_timer_mode(struct snd_pcm_substream *substream,
				bool enable_timer);
#ifndef CONFIG_SND_SOC_DBMDX_ALEXA
