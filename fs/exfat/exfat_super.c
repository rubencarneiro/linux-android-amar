...
#endif
{
	...
	dentry->d_time = (unsigned long)(atomic64_read(&(dentry->d_parent->d_inode->i_version)));
...
#endif
{
	...
	(unsigned long)(atomic64_read(&(dentry->d_parent->d_inode->i_version)));
                       ...
                       u32 request_mask, unsigned int query_flags)
{
        ...
        return 0;
#else
	struct inode *inode = d_inode(path->dentry);//dentry->d_inode;
