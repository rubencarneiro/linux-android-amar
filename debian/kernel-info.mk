...
# Kernel base version
KERNEL_BASE_VERSION = 4.19-127

# The kernel cmdline to use
KERNEL_BOOTIMAGE_CMDLINE = console=tty0 console=ttyMT3,921600n1 root=/dev/ram vmalloc=496M slub_max_order=0 slub_debug=O droidian.lvm.prefer
...
# Defconfig to use
KERNEL_DEFCONFIG = amar_row_wifi_ubuntu_defconfig
...
# If you leave this undefined, an attempt to find it automatically
# will be made.
KERNEL_IMAGE_DTB_OVERLAY = arch/arm64/boot/dts/mediatek/amar_row_wifi.dtb
...
# Android property. If you don't want to specify this, leave it undefined,
# FLASH_INFO_CPU will be checked instead.
FLASH_INFO_MODEL = Lenovo TB-X306F
